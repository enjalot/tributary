//tributary and options are passed into this code
//tributary is the main object available in inlets
//options has some gauranteed elements:
//{
//  pluginId: a UUID that will also be the element id of a div
//}
...
var el = document.getElementById(options.pluginId);
var config = tributary.__config__;

plugin.activate = function() {
  el = document.getElementById(options.pluginId);
  init();
  playButton();
  timeSlider();
  restartButton();
