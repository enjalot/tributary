...
$(function() {
    ...
    tributary.g = d3.select("#geysersvg").append("g").attr("id", "geyser")
    ...
    var gview = new tributary.GeyserView();
    gview.render()
    ...
    var barn = 1024
    var barh = 50;
    //create geyser bars for showing the frequency
    var geysergram = d3.select("#geysergram")
    var barg = geysergram.append("g").attr("id", "geyserbars")
    var empty = _.map(d3.range(1024), function(d) { return 0 }) 
    var bars = barg.selectAll("rect.geyserbar")
        .data(empty)
        .enter()
        .append("rect")
            .attr("class", "geyserbar")
    ...
    $("#geysergram").on("click", function(e) {
