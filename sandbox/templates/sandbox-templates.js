...
function program7(depth0,data) {
  ...
  if (stack1 = helpers.fullscreen) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.fullscreen; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  ...
  stack1 = helpers['if'].call(depth0, depth0.embed, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n";
  stack1 = helpers['if'].call(depth0, depth0.share, {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n</head>\n<body>\n<div id=\"container\">\n\n	<section id=\"display\">\n	</section>\n\n  <aside id=\"panel\" ";
  stack1 = helpers['if'].call(depth0, depth0.fullscreen, {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
